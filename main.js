...
var _user$project$Row$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			...
			case 'UpdateField':
				var _p16 = _p7._0;
				var _p14 = A2(_elm_lang$core$Debug$log, 'Edit only this field', _p16);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			case 'UpdateRow':
				...
				var _p10 = _p4._0;
				var _p5 = _p11;
				if (_p5.ctor === 'ChangePresentation') {
					var _p9 = _p5._0;
					var _p6 = _p9;
					if (_p6.ctor === 'Form') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								mo2,
								{
									focused_row: _elm_lang$core$Maybe$Just(_p10),
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									rows: A3(_user$project$Tab$update_row, _p10, _p11, model)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
						...
						model,
						{
							...
							rows: A2(
								...
								function (r) {
									var _p12 = A2(
										_user$project$Row$update,
										_user$project$Row$ChangeDensity(_p13),
										r);
									var mr = _p12._0;
									var cmd = _p12._1;
									return mr;
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('icon icon-hourglass pull-right')
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {name: a, rows: b, mode: c, fields: d, presentation: e, density: f, is_open: g, page: h, page_size: i, uid: j, focused_row: k};
										};
									};
								};
							};
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								if (_p19.ctor === 'Just') {
									...
									return A2(
										_elm_lang$html$Html_App$map,
										_user$project$Tab$UpdateRow(_p20.row_id),
										_user$project$Row$view(_p20));
								} else {
									return A2(
										_elm_lang$html$Html$div,
										_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$in_opened_windows = F2(
	function (opened_windows, window_id) {
		return _elm_lang$core$Basics$not(
...
var _user$project$Main$update_activated_window = F2(
	function (opened_windows, window_id) {
		return A2(_user$project$Main$in_opened_windows, opened_windows, window_id) ? A2(
			_elm_lang$core$List$map,
			function (w) {
				if (_elm_lang$core$Native_Utils.eq(w.window_id, window_id)) {
					var _p0 = A2(_user$project$Window$update, _user$project$Window$ActivateWindow, w);
					var mo = _p0._0;
					var cmd = _p0._1;
					return mo;
				} else {
					var _p1 = A2(_user$project$Window$update, _user$project$Window$DeactivateWindow, w);
					var mo = _p1._0;
					var cmd = _p1._1;
					return mo;
				}
