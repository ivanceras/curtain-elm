...
var _user$project$Field$stringifyMaybeValue = function (value) {
	var _p10 = value;
	if (_p10.ctor === 'Just') {
		return _user$project$Field$stringValue(_p10._0);
	} else {
		return '';
	}
};
var _user$project$Field$stringifyValue = function (model) {
	return _user$project$Field$stringifyMaybeValue(model.value);
};
var _user$project$Field$createSelectedReadRow = F4(
	function (fields, keyField, dao, model) {
		var width = function () {
			var _p11 = model.field.displayLength;
			if (_p11.ctor === 'Just') {
				return _p11._0 * 10;
			} else {
				return 200;
		...
		return A2(
			...
			A2(
				...
				function (f) {
					var _p12 = keyField;
					if (_p12.ctor === 'Just') {
						var pkValue = A2(_user$project$Field$getValue, _p12._0, dao);
						if (_elm_lang$core$Native_Utils.eq(pkValue, model.value)) {
							var _p13 = A2(_user$project$Field$getValue, f, dao);
							if (_p13.ctor === 'Just') {
								return _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										_user$project$Field$stringValue(_p13._0),
										' '));
							} else {
								return _elm_lang$html$Html$text('');
							}
						...
						return _elm_lang$core$Native_Utils.crashCase(
							'Field',
							{
								start: {line: 741, column: 13},
								end: {line: 753, column: 46}
							},
							_p12)('no keyfield');
					}
				},
...
var _user$project$Field$createListboxRow = F4(
	function (fields, keyField, dao, model) {
		var rowView = A2(
			_elm_lang$core$List$map,
			function (f) {
				var _p16 = A2(_user$project$Field$getValue, f, dao);
				if (_p16.ctor === 'Just') {
					return _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Field$stringValue(_p16._0),
							' '));
				} else {
					return _elm_lang$html$Html$text('');
				}
		...
		var attributes = function () {
			var _p17 = keyField;
			if (_p17.ctor === 'Just') {
				var pkValue = A2(_user$project$Field$getValue, _p17._0, dao);
				return _elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(
						_user$project$Field$stringifyMaybeValue(pkValue)),
...
var _user$project$Field$createCompactListField = F3(
	function (fieldList, daoList, model) {
		var width = function () {
			var _p18 = model.field.displayLength;
			if (_p18.ctor === 'Just') {
				return 10 * _p18._0;
			} else {
				return 200;
		...
		var keyField = _user$project$Field$getKeyField(fieldList);
		var fields = function () {
			var _p19 = _user$project$Field$mostSignificantField(fieldList);
			if (_p19.ctor === 'Just') {
				return _elm_lang$core$Native_List.fromArray(
					[_p19._0]);
			} else {
...
var _user$project$Field$lookupView = function (model) {
	...
	if (_p20.ctor === 'Just') {
		var _p22 = _p20._0;
		var fieldList = A2(_user$project$Field$tableLookupTabFields, model.lookupTabs, _p22);
		var daoList = A2(_user$project$Field$tableLookupData, model.lookupData, _p22);
		var _p21 = model.mode;
		if (_p21.ctor === 'Edit') {
			return A2(
				_elm_lang$html$Html$div,
	...
	if (_p23.ctor === 'Just') {
		...
		switch (_p24.ctor) {
			case 'String':
				...
				var width = function () {
					var _p25 = model.field.displayLength;
					if (_p25.ctor === 'Just') {
						return 10 * _p25._0;
					} else {
						return 200;
				...
				return _elm_lang$core$String$isEmpty(_p26) ? A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
			...
			case 'DateTime':
				return _elm_lang$html$Html$text(
					_user$project$Utils$simpleDate(_p24._0));
			default:
				return _elm_lang$html$Html$text(
...
var _user$project$Field$fieldRead = function (model) {
	var _p28 = model.field.reference;
	if (_p28 === 'Table') {
...
var _user$project$Field$isEmptyValue = function (value) {
	...
	if (_p29.ctor === 'Just') {
		var _p30 = _p29._0;
		if (_p30.ctor === 'String') {
			return _elm_lang$core$String$isEmpty(_p30._0);
		} else {
			return false;
		}
	} else {
...
var _user$project$Field$tooltipText = function (field) {
	var _p31 = field.description;
	if (_p31.ctor === 'Just') {
		var _p32 = _p31._0;
		return _elm_lang$core$Basics$not(
			_elm_lang$core$String$isEmpty(
				_elm_lang$core$String$trim(_p32))) ? A2(
			_elm_lang$html$Html$span,
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$Field$Uuid = function (a) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(
								_user$project$Field$String(_p34._0))
						}),
			...
			case 'ChangeValueBool':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							value: _elm_lang$core$Maybe$Just(
								_user$project$Field$Bool(_p34._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeMode':
			...
			case 'SetValue':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(_p34._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$Field$fieldEntry = function (model) {
	...
	var _p39 = model.field.reference;
	if (_p39 === 'Table') {
		return _user$project$Field$lookupView(model);
	} else {
		...
		switch (_p40) {
				...
				if ((_elm_lang$core$Native_Utils.cmp(width, 200) > 0) && _elm_lang$core$Native_Utils.eq(model.presentation, _user$project$Presentation$Form)) {
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_user$project$Field$stringifyMaybeValue(model.value))
							]));
				} else {
					return A2(
			...
			case 'Bool':
				var boolValue = function () {
					var _p41 = model.value;
					if ((_p41.ctor === 'Just') && (_p41._0.ctor === 'Bool')) {
						return _p41._0._0;
					} else {
						return false;
					}
...
var _user$project$Field$view = function (model) {
	var width = function () {
		var _p42 = model.field.displayLength;
		if (_p42.ctor === 'Just') {
			return _p42._0 * 10;
		} else {
			return 200;
		...
		default:
			...
			if (_p48.ctor === 'Edit') {
				...
				switch (_p49.ctor) {
					...
					default:
						var width = function () {
							var _p50 = model.field.displayLength;
							if (_p50.ctor === 'Just') {
								return _p50._0 * 10;
							} else {
								return 200;
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$Row$EditRecordInForm)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
...
var _user$project$Tab$removeFocusedRecord = function (model) {
	var updatedRows = A2(
		_elm_lang$core$List$map,
		function (r) {
			var _p5 = A2(_user$project$Row$update, _user$project$Row$LooseFocusRecord, r);
			var mo = _p5._0;
			var cmd = _p5._1;
			return mo;
		},
...
var _user$project$Tab$updateFocusedRow = F2(
	function (rowId, model) {
		...
		var updatedRows = A2(
			...
			function (r) {
				if (_elm_lang$core$Native_Utils.eq(r.rowId, rowId)) {
					var _p7 = A2(_user$project$Row$update, _user$project$Row$FocusRecord, r);
					var mo = _p7._0;
					var cmd = _p7._1;
					return mo;
				} else {
					var _p8 = A2(_user$project$Row$update, _user$project$Row$LooseFocusRecord, r);
					var mo = _p8._0;
					var cmd = _p8._1;
					return mo;
				}
	...
	if (_p9.ctor === 'Nothing') {
		...
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (r) {
					return _elm_lang$core$Native_Utils.eq(r.rowId, _p9._0);
				},
				model.rows));
	}
};
	...
	function (msg, model) {
		...
		switch (_p12.ctor) {
			case 'UpdateRow':
				...
				switch (_p13.ctor) {
					case 'FocusRecord':
						return {
							...
							_0: A3(
								...
								_p15,
								_p14,
								A2(_user$project$Tab$updateFocusedRow, _p14, model)),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Selection':
						...
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Tab$updateRow, _p15, _p14, updatedModel),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'EditRecordInForm':
						return {
							ctor: '_Tuple2',
							_0: A2(
								_user$project$Tab$updateMode,
								_user$project$Presentation$Edit,
								A2(
									_user$project$Tab$updatePresentation,
									_user$project$Presentation$Form,
									A3(
										_user$project$Tab$updateRow,
										_p15,
										_p14,
					...
					default:
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Tab$updateRow, _p15, _p14, model),
							_1: _elm_lang$core$Platform_Cmd$none
						};
				}
			case 'ChangeMode':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$updateMode, _p12._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangePresentation':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$updatePresentation, _p12._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeDensity':
				var _p16 = _p12._0;
				return {
					...
					_0: A2(
						...
						_user$project$Row$ChangeDensity(_p16),
						_elm_lang$core$Native_Utils.update(
							model,
							{density: _p16})),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'TabDataReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$createRows, model, _p12._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectionAll':
				return {
					...
					_0: A2(
						_user$project$Tab$updateAllRows,
						_user$project$Row$Selection(_p12._0),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LookupTabsReceived':
				var listLookupFields = _user$project$Tab$buildLookupField(_p12._0);
				return {
					ctor: '_Tuple2',
					_0: A2(
						_user$project$Tab$updateAllRows,
			...
			case 'LookupDataReceived':
				return {
					...
					_0: A2(
						_user$project$Tab$updateAllRows,
						_user$project$Row$LookupDataReceived(_p12._0),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Open':
			...
			case 'TableScrolled':
				var _p17 = A2(_elm_lang$core$Debug$log, 'help, im scrolled', 'hi...');
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'FormRecordClose':
				return {
					...
					_0: A2(
						_user$project$Tab$updateMode,
						_user$project$Presentation$Read,
						A2(_user$project$Tab$updatePresentation, _user$project$Presentation$Table, model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BrowserDimensionChanged':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{browserDimension: _p12._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$addToRows, model, _p12._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Tab$filterStatusView = function (model) {
	...
	var rowCountText = function () {
		var _p19 = model.tab.estimatedRowCount;
		if (_p19.ctor === 'Just') {
			return _elm_lang$html$Html$text(
...
var _user$project$Tab$onTableScroll = function (msg) {
	var _p21 = A2(_elm_lang$core$Debug$log, 'targetValue', _elm_lang$html$Html_Events$targetValue);
	var _p22 = A2(_elm_lang$core$Debug$log, 'scrolling...', msg);
	return A2(
		_elm_lang$html$Html_Events$on,
		'scroll',
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {tab: a, rows: b, mode: c, presentation: d, density: e, isOpen: f, page: g, pageSize: h, uid: i, focusedRow: j, tabId: k, allocatedHeight: l, browserDimension: m};
												};
											};
										};
									};
...
var _user$project$Tab$TableScrolled = function (a) {
	return {ctor: 'TableScrolled', _0: a};
};
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									if (_p27.ctor === 'Just') {
										...
										return A2(
											_elm_lang$html$Html_App$map,
											_user$project$Tab$UpdateRow(_p28.rowId),
											_user$project$Row$view(_p28));
									} else {
										return A2(
											_elm_lang$html$Html_App$map,
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Tab$ChangeMode(_user$project$Presentation$Edit))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Tab$ChangeMode(_user$project$Presentation$Read))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Tab$ChangePresentation(_user$project$Presentation$Form))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Tab$ChangePresentation(_user$project$Presentation$Grid))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Tab$ChangeDensity(_user$project$Presentation$Compact))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Tab$ChangeDensity(_user$project$Presentation$Medium))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Tab$ChangeDensity(_user$project$Presentation$Expanded))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$DataWindow$defaultDetailTableHeight = 200;
	...
	function (msg, model) {
		...
		switch (_p11.ctor) {
				...
				switch (_p12.ctor) {
					...
					case 'UpdateRow':
						...
						switch (_p13.ctor) {
							case 'ChangePresentation':
								var _p15 = _p13._0;
								var _p14 = A2(_elm_lang$core$Debug$log, 'Window: Changing presentation to ', _p15);
								return {
									ctor: '_Tuple2',
									_0: _user$project$DataWindow$updateAllocatedHeight(
										A2(
							...
							default:
								return {
									ctor: '_Tuple2',
									_0: A2(_user$project$DataWindow$updateMainTab, _p16, model),
									_1: _elm_lang$core$Platform_Cmd$none
								};
						}
					case 'FormRecordClose':
			...
			case 'WindowDetailReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$DataWindow$updateWindow, _p11._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'WindowDataReceived':
				return {
					ctor: '_Tuple2',
					_0: function () {
						var _p17 = _elm_lang$core$List$head(_p11._0);
						if (_p17.ctor === 'Just') {
							return A2(
								_user$project$DataWindow$updateMainTab,
								_user$project$Tab$TabDataReceived(_p17._0.daoList),
								model);
						} else {
							return model;
						}
			...
			case 'LookupTabsReceived':
				return {
					...
					_0: A2(
						_user$project$DataWindow$updateMainTab,
						_user$project$Tab$LookupTabsReceived(_p11._0),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LookupDataReceived':
				return {
					...
					_0: A2(
						_user$project$DataWindow$updateMainTab,
						_user$project$Tab$LookupDataReceived(_p11._0),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'OpenHasManyTab':
			...
			case 'FocusedRecordDataReceived':
				return {
					...
					_0: _user$project$DataWindow$openFirstMergedTab(
						A2(_user$project$DataWindow$hydrateAllMergedTab, _p11._1, model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BrowserDimensionChanged':
				var _p18 = _p11._0;
				return {
					...
					_0: _user$project$DataWindow$updateAllocatedHeight(
						A2(
							...
							_user$project$Tab$BrowserDimensionChanged(_p18),
							_elm_lang$core$Native_Utils.update(
								model,
								{browserDimension: _p18}))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleExtTab':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$DataWindow$updateExtTab, _user$project$Tab$Toggle, _p11._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LoadNextPage':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return {
					ctor: '_Tuple2',
					_0: function () {
						var _p19 = _elm_lang$core$List$head(_p11._0);
						if (_p19.ctor === 'Just') {
							return A2(
								_user$project$DataWindow$updateMainTab,
								_user$project$Tab$TabDataNextPageReceived(_p19._0.daoList),
								model);
						} else {
							return model;
						}
...
var _user$project$DataWindow$defaultMainTableHeight = 600;
var _user$project$DataWindow$create = F2(
	function (window, windowId) {
		return {
			...
			name: window.name,
			windowId: windowId,
			mainTab: A3(_user$project$Tab$create, window.mainTab, 0, _user$project$DataWindow$defaultMainTableHeight),
			nextTabId: 0,
			mainTableHeight: _user$project$DataWindow$defaultMainTableHeight,
			detailTableHeight: _user$project$DataWindow$defaultDetailTableHeight,
			browserDimension: _user$project$Tab$defaultBrowserDimension
		};
	});
...
var _user$project$DataWindow$windowDecoder = A9(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$list(_user$project$Tab$tabDecoder)));
var _user$project$DataWindow$TableDao = F2(
	function (a, b) {
		return {table: a, daoList: b};
	});
var _user$project$DataWindow$tableDaoDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$DataWindow$TableDao,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'table', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'dao_list',
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('icon icon-download icon-text')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text('Load More'),
						A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Load Next Page')
							]))
					]))
			]));
};
...
var _user$project$Settings$ApplySettings = {ctor: 'ApplySettings'};
var _user$project$Settings$ChangeDbUrl = function (a) {
	return {ctor: 'ChangeDbUrl', _0: a};
};
var _user$project$Settings$OpenWindow = {ctor: 'OpenWindow'};
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onClick(_user$project$Settings$CloseWindow)
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('db_url')
									])),
								A2(
								_elm_lang$html$Html$input,
								_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('api_server')
									])),
								A2(
								_elm_lang$html$Html$input,
								_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Settings$ApplySettings)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Apply Settings')
							]))
					]))
			]));
};
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {title: a, dbUrl: b, apiServer: c, windowList: d, openedWindows: e, error: f, uid: g, activeWindow: h, isSettingsOpened: i, browserDimension: j};
									};
								};
							};
						};
...
var _user$project$Main$getWindowDataWithQuery = F4(
	function (model, mainTable, windowId, query) {
		return A3(
			...
			A2(
				_evancz$elm_http$Http$fromJson,
				_elm_lang$core$Json_Decode$list(_user$project$DataWindow$tableDaoDecoder),
				A2(
...
var _user$project$Main$loadNextPage = F3(
	function (windowId, tab, model) {
		return A5(_user$project$Main$getWindowDataPage, tab.tab.table, windowId, 1, 20, model);
	});
var _user$project$Main$fetchFocusedRecordDetail = F3(
	function (model, windowId, rowId) {
		...
		if (_p15.ctor === 'Just') {
			...
			if (_p16.ctor === 'Just') {
				var _p17 = A2(_user$project$Tab$getRow, _p16._0.mainTab, rowId);
				if (_p17.ctor === 'Just') {
					var focusedParam = A2(
						_elm_lang$core$Basics_ops['++'],
						'[',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Row$focusedRecordParam(_p17._0),
							']'));
					return A3(
						_elm_lang$core$Task$perform,
						_user$project$Main$FetchError,
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 529, column: 21},
							end: {line: 537, column: 54}
						},
						_p17)('No such row');
				}
			} else {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 525, column: 5},
					end: {line: 542, column: 63}
				},
				_p15)('No matching table for focused record');
		}
	});
			...
			return A3(
				...
				A2(
					...
					A2(
						_user$project$Main$httpGet,
						model,
						A2(_elm_lang$core$Basics_ops['++'], '/lookup_data/', _p21._0))));
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 513, column: 5},
					end: {line: 519, column: 54}
				},
				_p21)('Unable to get matching table');
		}
	});
			...
			return A3(
				...
				A2(
					...
					A2(
						_user$project$Main$httpGet,
						model,
						A2(_elm_lang$core$Basics_ops['++'], '/lookup_tabs/', _p23._0))));
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 501, column: 5},
					end: {line: 507, column: 54}
				},
				_p23)('Unable to get matching table');
		}
	});
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Settings$view(
									A2(_user$project$Settings$create, model.dbUrl, model.apiServer))) : A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
...
var _user$project$Main$init = {
	...
	_1: _elm_lang$core$Platform_Cmd$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$fetchWindowList(_user$project$Main$appModel),
	...
	function (msg, model) {
		...
		switch (_p25.ctor) {
			case 'UpdateWindow':
				...
				var _p30 = _p25._0;
				var _p26 = msg;
				if ((((_p26.ctor === 'UpdateWindow') && (_p26._1.ctor === 'UpdateTab')) && (_p26._1._0.ctor === 'UpdateRow')) && (_p26._1._0._1.ctor === 'FocusRecord')) {
					var _p27 = _p26._0;
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$updateWindow, model, _p31, _p27),
						_1: A3(_user$project$Main$fetchFocusedRecordDetail, model, _p27, _p26._1._0._0)
					};
				} else {
					var _p28 = _p31;
					if (_p28.ctor === 'LoadNextPage') {
						var _p29 = A2(_elm_lang$core$Debug$log, 'Loading next page', 'page');
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Main$updateWindow, model, _p31, _p30),
							_1: A3(_user$project$Main$loadNextPage, _p30, _p28._0, model)
						};
					} else {
						return {
							ctor: '_Tuple2',
				...
				return {
					...
					_0: _user$project$Main$updateActivatedWindowList(
						_user$project$Main$updateActivatedWindows(
							A2(_user$project$Main$closeWindow, model, _p25._0))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ActivateWindow':
				return {
					...
					_0: _user$project$Main$updateActivatedWindowList(
						_user$project$Main$updateActivatedWindows(
							_elm_lang$core$Native_Utils.update(
								model,
								{
									activeWindow: _elm_lang$core$Maybe$Just(_p25._0)
								}))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateWindowList':
				var _p32 = _p25._0;
				if (_p32.ctor === 'LoadWindow') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_user$project$Main$fetchWindowDetail, model, _p32._0)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'WindowListReceived':
				var _p33 = A2(
					_user$project$WindowList$update,
					_user$project$WindowList$WindowListReceived(_p25._0),
					model.windowList);
				var wm = _p33._0;
				var cmd = _p33._1;
				return {
			...
			case 'WindowDetailReceived':
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$updateActivatedWindowList(
						A2(_user$project$Main$displayWindowDetail, model, _p34)),
					_1: A3(_user$project$Main$getWindowData, model, _p34.table, model.uid)
				};
			case 'LoadWindow':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$fetchWindowDetail, model, _p25._0)
				};
			case 'GetWindowData':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'WindowDataReceived':
				...
				return {
					...
					_0: A3(
						...
						model,
						_user$project$DataWindow$WindowDataReceived(_p25._1),
						_p35),
					_1: A2(_user$project$Main$fetchLookupTabs, model, _p35)
				};
			case 'LookupTabsReceived':
				var _p36 = _p25._0;
				return {
					...
					_0: A3(
						_user$project$Main$updateWindow,
						model,
						_user$project$DataWindow$LookupTabsReceived(_p25._1),
						_p36),
					_1: A2(_user$project$Main$fetchLookupData, model, _p36)
				};
			case 'LookupDataReceived':
				return {
					ctor: '_Tuple2',
					_0: A3(
						_user$project$Main$updateWindow,
						model,
						_user$project$DataWindow$LookupDataReceived(_p25._1),
						_p25._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchError':
			...
			case 'FocusedRecordDataReceived':
				return {
					...
					_0: A3(
						_user$project$Main$updateWindow,
						model,
						A2(_user$project$DataWindow$FocusedRecordDataReceived, _p25._1, _p25._2),
						_p25._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'WindowResize':
				...
				var updatedDimension = _elm_lang$core$Native_Utils.update(
					dimension,
					{width: _p38.width, height: _p38.height});
				return {
					ctor: '_Tuple2',
					_0: A2(
			...
			default:
				var _p40 = _p25._0;
				var _p39 = A2(_elm_lang$core$Debug$log, 'got next page for ', _p40);
				return {
					ctor: '_Tuple2',
					_0: A3(
						_user$project$Main$updateWindow,
						model,
						_user$project$DataWindow$WindowDataNextPageReceived(_p25._1),
						_p40),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
