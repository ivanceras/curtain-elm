...
var _user$project$Dao$listEncoder = F2(
	function (encoder, payload) {
...
var _user$project$Dao$daoEncoder = function (dao) {
	return _elm_lang$core$Json_Encode$object(
		A2(
			_elm_lang$core$List$map,
			function (_p3) {
...
var _user$project$Dao$daoListEncoder = function (daoList) {
	return A2(_user$project$Dao$listEncoder, _user$project$Dao$daoEncoder, daoList);
};
var _user$project$Dao$daoUpdateEncoder = function (daoUpdate) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'original',
				_1: _user$project$Dao$daoEncoder(daoUpdate.original)
			},
				{
				ctor: '_Tuple2',
				_0: 'updated',
				_1: _user$project$Dao$daoEncoder(daoUpdate.updated)
			}
			]));
};
var _user$project$Dao$daoUpdateListEncoder = function (daoUpdateList) {
	return A2(_user$project$Dao$listEncoder, _user$project$Dao$daoUpdateEncoder, daoUpdateList);
};
var _user$project$Dao$daoInsertEncoder = function (daoInsert) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'dao',
				_1: _user$project$Dao$daoEncoder(daoInsert.dao)
			},
				{
				ctor: '_Tuple2',
				_0: 'record_id',
				_1: _elm_lang$core$Json_Encode$string(daoInsert.recordId)
			}
			]));
};
var _user$project$Dao$daoInsertListEncoder = function (daoInsertList) {
	return A2(_user$project$Dao$listEncoder, _user$project$Dao$daoInsertEncoder, daoInsertList);
};
var _user$project$Dao$forSaveChangeset = F3(
	function (table, daoUpdateList, daoInsertList) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{
				table: table,
...
var _user$project$Dao$deletedChangeset = F3(
	function (table, daoList, force) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{
				table: table,
...
var _user$project$Dao$changeSetEncoder = function (changeset) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'deleted',
				_1: _user$project$Dao$daoListEncoder(changeset.deleted)
			},
				{
				ctor: '_Tuple2',
				_0: 'inserted',
				_1: A2(_user$project$Dao$listEncoder, _user$project$Dao$daoInsertEncoder, changeset.inserted)
			},
				{
				ctor: '_Tuple2',
				_0: 'updated',
				_1: A2(_user$project$Dao$listEncoder, _user$project$Dao$daoUpdateEncoder, changeset.updated)
			},
				{
				ctor: '_Tuple2',
				_0: 'delete_referring',
				_1: _elm_lang$core$Json_Encode$bool(changeset.deleteReferring)
			}
			]));
};
var _user$project$Dao$changeSetListEncoder = function (changelist) {
	return _elm_lang$core$Json_Encode$list(
		A2(
			_elm_lang$core$List$map,
			function (c) {
				return _user$project$Dao$changeSetEncoder(c);
			},
			changelist));
};
...
var _user$project$Dao$DaoInsert = F2(
	function (a, b) {
		return {recordId: a, dao: b};
	});
var _user$project$Dao$DaoUpdate = F2(
	function (a, b) {
		return {original: a, updated: b};
	});
var _user$project$Dao$Changeset = F5(
	function (a, b, c, d, e) {
		return {table: a, inserted: b, deleted: c, updated: d, deleteReferring: e};
	});
var _user$project$Dao$UpdateResponse = F8(
	function (a, b, c, d, e, f, g, h) {
		return {table: a, inserted: b, inserteError: c, deleted: d, deleteError: e, updated: f, updateError: g, totalRecords: h};
	});
...
var _user$project$Dao$updateResponseDecoder = A9(
	_elm_lang$core$Json_Decode$object8,
	_user$project$Dao$UpdateResponse,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'table', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'inserted',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$list(
			A3(
				...
				_user$project$Dao$daoDecoder,
				_elm_lang$core$Json_Decode$string))),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'total_records', _elm_lang$core$Json_Decode$int));
...
var _user$project$Utils$px = function (number) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$Field$isModified = function (model) {
	return (!_elm_lang$core$Native_Utils.eq(model.orig_value, _elm_lang$core$Maybe$Nothing)) && (!_elm_lang$core$Native_Utils.eq(model.value, model.orig_value));
};
...
var _user$project$Field$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {field: a, value: b, orig_value: c, mode: d, presentation: e, focused: f, density: g};
	});
...
var _user$project$Field$computeSize = function (model) {
	return A2(_user$project$Field$computeSizeFromField, model.field, model.presentation);
};
var _user$project$Field$computeWidth = function (model) {
	return _elm_lang$core$Basics$fst(
		_user$project$Field$computeSize(model));
};
var _user$project$Field$computeHeight = function (model) {
	return _elm_lang$core$Basics$snd(
		_user$project$Field$computeSize(model));
};
				...
				var fieldStyle = _elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'width',
							_1: _user$project$Utils$px(width)
						},
							{
							ctor: '_Tuple2',
							_0: 'height',
...
var _user$project$Field$create = function (field) {
	return {field: field, value: _elm_lang$core$Maybe$Nothing, orig_value: _elm_lang$core$Maybe$Nothing, mode: _user$project$Mode$Read, presentation: _user$project$Field$Table, focused: false, density: _user$project$Mode$Expanded};
};
var _user$project$Field$CancelChanges = {ctor: 'CancelChanges'};
var _user$project$Field$UpdateValue = function (a) {
...
var _user$project$Row$isNew = function (model) {
	return A2(
		_elm_lang$core$List$all,
		function (f) {
			return _user$project$Field$isNew(f);
		},
		model.fieldModels);
};
...
var _user$project$Row$equalDao = F2(
	function (model, dao) {
		return _elm_lang$core$Native_Utils.eq(
			dao,
			_user$project$Row$getOrigDao(model));
	});
var _user$project$Row$matchPrimary = F2(
	function (model, dao) {
		var origDao = _user$project$Row$getOrigDao(model);
		var keyFields = _user$project$Row$keyFieldModels(model.fieldModels);
		return A2(
			_elm_lang$core$List$all,
			function (key) {
				var _p7 = A2(_elm_lang$core$Debug$log, 'keyfield', key);
				return _elm_lang$core$Native_Utils.eq(
					A2(_elm_lang$core$Dict$get, key.field.column, origDao),
					A2(_elm_lang$core$Dict$get, key.field.column, dao));
			},
			keyFields);
	});
		...
		A2(
			...
			function (f) {
				...
				if (_p8.ctor === 'Nothing') {
					...
					return _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: f.field.column, _1: _p8._0});
				}
			},
			model.fieldModels));
};
var _user$project$Row$getDaoUpdate = function (model) {
	return {
		original: _user$project$Row$getOrigDao(model),
		updated: _user$project$Row$getDao(model)
	};
};
var _user$project$Row$getDaoInsert = function (model) {
	return {
...
var _user$project$Row$UpdateDao = function (a) {
	return {ctor: 'UpdateDao', _0: a};
};
var _user$project$Row$SetDao = function (a) {
	return {ctor: 'SetDao', _0: a};
};
...
var _user$project$Row$view = function (model) {
	var fieldModels = _user$project$Row$excludeKeyfieldModels(
		A2(_user$project$Row$filterFieldModelsWithDensity, model.fieldModels, model.density));
		...
		switch (_p11.ctor) {
				...
				return {
					...
					_0: A2(
						...
						_user$project$Field$ChangePresentation(
							_user$project$Row$mapFieldPresentation(_p13)),
						_elm_lang$core$Native_Utils.update(
							model,
							{presentation: _p13})),
					_1: _elm_lang$core$Native_List.fromArray(
			...
			case 'SetDao':
				var fieldModels = A2(
					_elm_lang$core$List$map,
					function (f) {
						var value = A2(_elm_lang$core$Dict$get, f.field.column, _p11._0);
						var _p16 = value;
						if (_p16.ctor === 'Just') {
							var _p17 = A2(
				...
				var fieldModels = A2(
					...
					function (f) {
						...
						if (_p18.ctor === 'Just') {
							var _p19 = A2(
								_user$project$Field$update,
								_user$project$Field$UpdateValue(_p18._0),
								f);
							var field1 = _p19._0;
							var outmsg1 = _p19._1;
							return field1;
...
var _user$project$SearchBox$create = function (field) {
	return {
		field: field,
		operatorValue: _elm_lang$core$Native_List.fromArray(
			[]),
		fromDate: _elm_lang$core$Basics$fst(
			_Bogdanp$elm_datepicker$DatePicker$init(
				_elm_lang$core$Native_Utils.update(
					_Bogdanp$elm_datepicker$DatePicker$defaultSettings,
					{placeholder: 'from'}))),
		toDate: _elm_lang$core$Maybe$Nothing
	};
};
var _user$project$SearchBox$operatorToQuery = function (op) {
	var _p0 = op;
	switch (_p0.ctor) {
		case 'StartsWith':
			return 'st';
...
var _user$project$SearchBox$searchBoxToQuery = function (model) {
	var conditions = A3(
		_elm_lang$core$List$foldl,
		F2(
			function (_p1, conditions) {
				var _p2 = _p1;
				var sv = _user$project$Dao$stringValue(_p2._1);
				var ops = _user$project$SearchBox$operatorToQuery(_p2._0);
				if (_elm_lang$core$String$isEmpty(sv)) {
					return conditions;
				} else {
					var cond = A2(
						_elm_lang$core$Basics_ops['++'],
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								ops,
								A2(_elm_lang$core$Basics_ops['++'], '.', sv))));
					return A2(
						_elm_lang$core$Basics_ops['++'],
						conditions,
						_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		model.operatorValue);
	return A2(_elm_lang$core$String$join, '&', conditions);
};
var _user$project$SearchBox$Model = F4(
	function (a, b, c, d) {
		return {field: a, operatorValue: b, fromDate: c, toDate: d};
	});
var _user$project$SearchBox$Clear = {ctor: 'Clear'};
var _user$project$SearchBox$ToDatePicker = function (a) {
	return {ctor: 'ToDatePicker', _0: a};
};
var _user$project$SearchBox$ChangeValueBool = function (a) {
	return {ctor: 'ChangeValueBool', _0: a};
};
var _user$project$SearchBox$ChangeValue = function (a) {
	return {ctor: 'ChangeValue', _0: a};
};
var _user$project$SearchBox$view = function (model) {
	var firstValue = function () {
		var _p3 = _elm_lang$core$List$head(model.operatorValue);
		if (_p3.ctor === 'Just') {
			return _p3._0._1;
		} else {
			return _user$project$Dao$String('');
		}
	}();
	var field = model.field;
	var _p4 = A2(_user$project$Field$computeSizeFromField, field, _user$project$Field$Table);
	var width = _p4._0;
	var height = _p4._1;
	var search_width = width - 18;
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('checkbox'),
								_elm_lang$html$Html_Events$onCheck(_user$project$SearchBox$ChangeValueBool),
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										ctor: '_Tuple2',
										_0: 'width',
										_1: _user$project$Utils$px(search_width)
									},
										{ctor: '_Tuple2', _0: 'border-radius', _1: '6px'},
										{ctor: '_Tuple2', _0: 'border', _1: '1px  solid #ccc'},
										{ctor: '_Tuple2', _0: 'padding-right', _1: '18px'}
									])),
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$name('search'),
								_elm_lang$html$Html_Attributes$value(
								_user$project$Dao$stringValue(firstValue)),
								_elm_lang$html$Html_Events$onInput(_user$project$SearchBox$ChangeValue)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
...
var _user$project$SearchBox$None = {ctor: 'None'};
var _user$project$SearchBox$LessThanEqual = {ctor: 'LessThanEqual'};
var _user$project$SearchBox$LessThan = {ctor: 'LessThan'};
var _user$project$SearchBox$GreaterThanEqual = {ctor: 'GreaterThanEqual'};
var _user$project$SearchBox$GreaterThan = {ctor: 'GreaterThan'};
var _user$project$SearchBox$Like = {ctor: 'Like'};
var _user$project$SearchBox$Equal = {ctor: 'Equal'};
var _user$project$SearchBox$StartsWith = {ctor: 'StartsWith'};
var _user$project$SearchBox$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
						...
						model,
						{
							operatorValue: _elm_lang$core$Native_List.fromArray(
								[
									{
									ctor: '_Tuple2',
									_0: _user$project$SearchBox$StartsWith,
									_1: _user$project$Dao$String(_p7._0)
								}
								])
						}),
					_1: _elm_lang$core$Native_List.fromArray(
						...
						model,
						{
							operatorValue: _elm_lang$core$Native_List.fromArray(
								[
									{
									ctor: '_Tuple2',
									_0: _user$project$SearchBox$Equal,
									_1: _user$project$Dao$Bool(_p7._0)
								}
								])
						}),
					_1: _elm_lang$core$Native_List.fromArray(
			...
			default:
				var _p8 = A2(_Bogdanp$elm_datepicker$DatePicker$update, _p7._0, model.fromDate);
...
var _user$project$Tab$hydrateModel = F3(
	function (model, rows, tableDao) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				rows: rows,
				...
				totalPage: function () {
					var _p1 = tableDao.total;
					if (_p1.ctor === 'Just') {
						var _p2 = tableDao.pageSize;
						if (_p2.ctor === 'Just') {
							var _p3 = _p2._0;
							var totalPage = (((_p1._0 + _p3) - 1) / _p3) | 0;
...
var _user$project$Tab$setTabRows = F2(
	function (model, tableDao) {
		...
		return A3(_user$project$Tab$hydrateModel, model, rows, tableDao);
	});
var _user$project$Tab$addToRows = F2(
	function (model, tableDao) {
		var rows = A2(_user$project$Tab$createRows, model, tableDao.daoList);
		return A3(
			_user$project$Tab$hydrateModel,
			model,
...
var _user$project$Tab$hasFocusedRow = function (model) {
	var _p5 = _user$project$Tab$focusedRow(model);
	if (_p5.ctor === 'Just') {
		return true;
	} else {
		return false;
...
var _user$project$Tab$inDeleted = F2(
	function (updateResponse, row) {
		return A2(
			_elm_lang$core$List$any,
			function (d) {
				return A2(_user$project$Row$equalDao, row, d);
			},
			updateResponse.deleted);
	});
var _user$project$Tab$updateRowFromResponse = F2(
	function (updateResponse, row) {
		var matchedDao = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (r) {
					return A2(_user$project$Row$matchPrimary, row, r);
				},
				updateResponse.updated));
		var _p6 = A2(_elm_lang$core$Debug$log, 'matched dao', matchedDao);
		var updatedRow = function () {
			var _p7 = matchedDao;
			if (_p7.ctor === 'Just') {
				var _p8 = A2(
					_user$project$Row$update,
					_user$project$Row$SetDao(_p7._0),
					row);
				var updatedRow = _p8._0;
				var outmsg = _p8._1;
				var _p9 = A2(
					_user$project$Row$update,
					_user$project$Row$ChangeMode(_user$project$Mode$Read),
					updatedRow);
				var updatedRow2 = _p9._0;
				var outmsg2 = _p9._1;
				return updatedRow2;
			} else {
				return row;
...
var _user$project$Tab$updateRecordFromResponse = F2(
	function (model, updateResponse) {
		var rows = A2(
			_elm_lang$core$List$filter,
			function (row) {
				return _elm_lang$core$Basics$not(
					A2(_user$project$Tab$inDeleted, updateResponse, row));
			},
			model.rows);
		var updatedRows = A2(
			_elm_lang$core$List$map,
			function (row) {
				return A2(_user$project$Tab$updateRowFromResponse, updateResponse, row);
			},
			rows);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				rows: updatedRows,
				totalRecords: _elm_lang$core$Maybe$Just(updateResponse.totalRecords)
			});
	});
var _user$project$Tab$shallLoadNextPage = function (model) {
	var totalRecords = function () {
		var _p10 = model.totalRecords;
		if (_p10.ctor === 'Just') {
			return _p10._0;
		} else {
			return -1;
...
var _user$project$Tab$shallAutoLoadNextPage = function (model) {
	var rowLength = _elm_lang$core$List$length(model.rows);
	var _p11 = model.pageSize;
	if (_p11.ctor === 'Just') {
		return (_elm_lang$core$Native_Utils.cmp(rowLength, _p11._0) < 0) && _user$project$Tab$shallLoadNextPage(model);
	} else {
		return false;
	}
};
var _user$project$Tab$updateRow = F3(
	function (rowMsg, rowId, model) {
		var rows_out = A2(
			_elm_lang$core$List$map,
			function (r) {
				return _elm_lang$core$Native_Utils.eq(r.rowId, rowId) ? A2(_user$project$Row$update, rowMsg, r) : {
					ctor: '_Tuple2',
					_0: r,
					_1: _elm_lang$core$Native_List.fromArray(
						[])
			...
			model.rows);
		var _p12 = _elm_lang$core$List$unzip(rows_out);
		var rows = _p12._0;
		var outmsgs = _p12._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{rows: rows}),
			_1: _elm_lang$core$List$concat(outmsgs)
		};
	});
var _user$project$Tab$getSearchBoxQuery = function (model) {
	var queries = A2(
		_elm_lang$core$List$filter,
		function (ss) {
			return _elm_lang$core$Basics$not(
				_elm_lang$core$String$isEmpty(ss));
		},
		A2(
			_elm_lang$core$List$map,
			function (sb) {
				return _user$project$SearchBox$searchBoxToQuery(sb);
			},
			model.searchBoxes));
	return A2(_elm_lang$core$String$join, '&', queries);
};
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				rows: A2(
					...
					function (r) {
						return _elm_lang$core$Native_Utils.eq(r.rowId, rowId) ? _elm_lang$core$Basics$fst(
							A2(_user$project$Row$update, _user$project$Row$FocusRecord, r)) : _elm_lang$core$Basics$fst(
							A2(_user$project$Row$update, _user$project$Row$LooseFocusRecord, r));
					},
					model.rows)
			});
...
var _user$project$Tab$getSearchBox = F2(
	function (field, model) {
		return A2(
			_elm_community$list_extra$List_Extra$find,
			function (sb) {
				return _elm_lang$core$Native_Utils.eq(field, sb.field);
			},
			model.searchBoxes);
	});
var _user$project$Tab$insertedRows = function (model) {
	return A2(
		_elm_lang$core$List$filter,
		function (r) {
			return _user$project$Row$isNew(r);
		},
		model.rows);
};
var _user$project$Tab$insertedRowCount = function (model) {
	return _elm_lang$core$List$length(
		_user$project$Tab$insertedRows(model));
};
...
var _user$project$Tab$onTableScroll = function (msg) {
	var _p15 = A2(_elm_lang$core$Debug$log, 'targetValue', _elm_lang$html$Html_Events$targetValue);
	var _p16 = A2(_elm_lang$core$Debug$log, 'scrolling...', msg);
	return A2(
		_elm_lang$html$Html_Events$on,
		'scroll',
		A2(_elm_lang$core$Json_Decode$map, msg, _elm_lang$core$Json_Decode$value));
};
var _user$project$Tab$rowShadowWidth = 125;
var _user$project$Tab$calcMainTableWidth = function (model) {
	var widthDeductions = 225;
	return model.browserDimension.width - (widthDeductions + _user$project$Tab$rowShadowWidth);
};
var _user$project$Tab$defaultBrowserDimension = {width: 0, height: 0, scrollBarWidth: 13};
var _user$project$Tab$createSearchBox = function (tab) {
	return A2(
		_elm_lang$core$List$map,
		function (field) {
			return _user$project$SearchBox$create(field);
		},
		tab.fields);
};
var _user$project$Tab$create = F4(
	function (tab, tabId, height, presentation) {
		return {
			...
			loadingPage: false,
			searchBoxes: _user$project$Tab$createSearchBox(tab)
		};
	});
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {tab: a, rows: b, mode: c, presentation: d, density: e, isOpen: f, page: g, pageSize: h, totalRecords: i, totalPage: j, uid: k, tabId: l, allocatedHeight: m, browserDimension: n, loadingPage: o, searchBoxes: p};
															};
														};
													};
												};
...
var _user$project$Tab$ClearFilters = {ctor: 'ClearFilters'};
var _user$project$Tab$UpdateSearchBox = F2(
	function (a, b) {
		return {ctor: 'UpdateSearchBox', _0: a, _1: b};
	});
	...
	function (model, filteredFields) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				function (f) {
					var sb = A2(_user$project$Tab$getSearchBox, f, model);
					var _p17 = sb;
					if (_p17.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'border-right', _1: '1px solid #ddd'}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									_elm_lang$html$Html_App$map,
									_user$project$Tab$UpdateSearchBox(f.column),
									_user$project$SearchBox$view(_p17._0))
								]));
					} else {
						return _elm_lang$html$Html$text('');
					}
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$List$map,
					function (f) {
						var _p18 = A2(_user$project$Field$computeSizeFromField, f, _user$project$Field$Table);
						var width = _p18._0;
						var height = _p18._1;
						return A2(
							_elm_lang$html$Html$th,
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											A2(_elm_lang$core$Maybe$withDefault, '', f.description))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
...
var _user$project$Tab$AddRowDao = function (a) {
	return {ctor: 'AddRowDao', _0: a};
};
var _user$project$Tab$UpdateRowDao = F2(
	function (a, b) {
		return {ctor: 'UpdateRowDao', _0: a, _1: b};
	});
...
var _user$project$Tab$frozenControlHead = function (model) {
	var selected = _user$project$Tab$selectedRowCount(model);
	var _p19 = (_elm_lang$core$Native_Utils.cmp(selected, 0) > 0) ? {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toString(selected),
		_1: A2(
			_elm_lang$core$Basics_ops['++'],
			'There are ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(selected),
				' records selected'))
	} : {ctor: '_Tuple2', _0: '', _1: ''};
	var selectedStr = _p19._0;
	var selectedTooltip = _p19._1;
	var allSelected = _user$project$Tab$areAllRecordSelected(model);
	var unselect = allSelected ? 'unselect' : 'select';
	var rows = _elm_lang$core$List$length(model.rows);
	var selectAllTooltipText = A2(
		_elm_lang$core$Basics_ops['++'],
		'Click to ',
		A2(
			_elm_lang$core$Basics_ops['++'],
	...
	var _p20 = function () {
		...
		if (_p21.ctor === 'Just') {
			...
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toString(rows),
				_1: ''
			};
		}
	}();
	var rowCountOverTotal = _p20._0;
	var rowCountOverTotalTooltip = _p20._1;
	return A2(
		_elm_lang$html$Html$table,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('frozenControlHead')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$title(selectedTooltip)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$title('Click to clear filter'),
												_elm_lang$html$Html_Events$onClick(_user$project$Tab$ClearFilters)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$title(selectAllTooltipText)
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$title(rowCountOverTotalTooltip)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(rowCountOverTotal)
									]))
							]))
					]))
			]));
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												ctor: '_Tuple2',
												_0: 'width',
												_1: _user$project$Utils$px(_user$project$Tab$rowShadowWidth)
											},
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'},
												{ctor: '_Tuple2', _0: 'border-right', _1: '1px dashed #ccc'}
											]))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('colum_head')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$class('main_table')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
...
var _user$project$Tab$FilterChanges = {ctor: 'FilterChanges'};
		...
		return A3(
			...
			F2(
				function (outmsg, _p25) {
					...
					switch (_p27.ctor) {
						case 'CancelChanges':
							return {ctor: '_Tuple2', _0: _p28, _1: _p29};
						case 'SaveChanges':
							return {ctor: '_Tuple2', _0: _p28, _1: _p29};
						case 'Remove':
							return {ctor: '_Tuple2', _0: _p28, _1: _p29};
						case 'FocusChanged':
							return {
								ctor: '_Tuple2',
								_0: A2(_user$project$Tab$updateFocusedRow, rowId, _p28),
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									_p29,
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_user$project$Tab$focusedRow(_p28))
										]))
							};
						default:
							return {
								ctor: '_Tuple2',
								_0: A2(_user$project$Tab$updateClickedRow, rowId, _p28),
								_1: _p29
							};
					}
				}),
...
var _user$project$Tab$updateThenHandleRowMsg = F3(
	function (rowMsg, rowId, model) {
		var _p30 = A3(_user$project$Tab$updateRow, rowMsg, rowId, model);
		var model1 = _p30._0;
		var rowOutMsgs = _p30._1;
		return A3(_user$project$Tab$handleRowOutMsg, rowOutMsgs, rowId, model1);
	});
...
var _user$project$Tab$update = F2(
	function (msg, model) {
		...
		switch (_p31.ctor) {
			case 'UpdateRow':
				return A3(_user$project$Tab$updateThenHandleRowMsg, _p31._1, _p31._0, model);
			case 'ChangeMode':
				var _p32 = _p31._0;
				return {
					ctor: '_Tuple2',
					_0: A2(
						...
						_user$project$Row$ChangeMode(_p32),
						_elm_lang$core$Native_Utils.update(
							model,
							{mode: _p32})),
					_1: _elm_lang$core$Native_List.fromArray(
			...
			case 'ChangeDensity':
				...
				return {
					...
					_0: A2(
						_user$project$Tab$updateRows,
						_user$project$Row$ChangeDensity(_p33),
						_elm_lang$core$Native_Utils.update(
							model,
							{density: _p33})),
					_1: _elm_lang$core$Native_List.fromArray(
			...
			case 'TabDataReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$setTabRows, model, _p31._0),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			case 'SelectionAll':
				return {
					...
					_0: A2(
						_user$project$Tab$updateRows,
						_user$project$Row$Selection(_p31._0),
						model),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			...
			case 'TabDataNextPageReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$addToRows, model, _p31._0),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			case 'ReceivedScrollBottomEvent':
				var _p34 = A2(_elm_lang$core$Debug$log, 'ReceivedScrollBottomEvent in Tab', '');
				return A2(
					_elm_lang$core$Debug$log,
					'shallLoadNextPage',
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{loadingPage: true}),
					_1: _elm_lang$core$Native_List.fromArray(
						[_user$project$Tab$LoadNextPage])
				} : {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Native_List.fromArray(
			...
			case 'RecordsUpdated':
				var model1 = A2(_user$project$Tab$updateRecordFromResponse, model, _p31._0);
				return _user$project$Tab$shallAutoLoadNextPage(model1) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model1,
						{loadingPage: true}),
			...
			case 'UpdateRowDao':
				return A3(
					...
					_user$project$Row$UpdateDao(_p31._1),
					_p31._0,
					model);
			case 'AddRowDao':
				var newRow = _elm_lang$core$Basics$fst(
					A2(
						_user$project$Row$update,
						_user$project$Row$UpdateDao(_p31._0),
						_elm_lang$core$Basics$fst(
							A2(
								_user$project$Row$update,
								_user$project$Row$ChangePresentation(_user$project$Row$Table),
								_elm_lang$core$Basics$fst(
									A2(
										_user$project$Row$update,
										_user$project$Row$ChangeMode(_user$project$Mode$Read),
				...
				var model1 = _elm_lang$core$Native_Utils.update(
					model,
					{
						searchBoxes: A2(
							_elm_lang$core$List$map,
							function (sb) {
								return _elm_lang$core$Native_Utils.eq(_p31._0, sb.field.column) ? _elm_lang$core$Basics$fst(
									A2(_user$project$SearchBox$update, _p31._1, sb)) : sb;
							},
							model.searchBoxes)
					});
				var filter = _user$project$Tab$getSearchBoxQuery(model1);
				var _p35 = A2(_elm_lang$core$Debug$log, 'searchQueries: ', filter);
				return {
					ctor: '_Tuple2',
					_0: model1,
					_1: _elm_lang$core$Native_List.fromArray(
						[_user$project$Tab$FilterChanges])
				};
			default:
				var _p36 = A2(_elm_lang$core$Debug$log, 'Tab clear filters', '');
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							searchBoxes: A2(
								...
								function (sb) {
									return _elm_lang$core$Basics$fst(
										A2(_user$project$SearchBox$update, _user$project$SearchBox$Clear, sb));
								},
								model.searchBoxes)
						}),
					_1: _elm_lang$core$Native_List.fromArray(
...
var _user$project$DataWindow$updateMainTab = F2(
	function (tabMsg, model) {
		...
		return {ctor: '_Tuple2', _0: model1, _1: outmsg};
	});
...
var _user$project$DataWindow$hydrateExtensionTab = F2(
				...
				extTabs: A2(
					...
					function (ext) {
						var _p6 = A2(
							_elm_lang$core$Debug$log,
							'Extention table',
							A2(_user$project$DataWindow$getTableDao, tableDaoList, ext.tab));
						if (_p6.ctor === 'Just') {
							return _elm_lang$core$Basics$fst(
								A2(
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				hasManyMergedTabs: A2(
					_elm_lang$core$List$map,
					function (tab) {
						var _p7 = A2(_user$project$DataWindow$getTableDao, tableDaoList, tab.tab);
						if (_p7.ctor === 'Just') {
							var _p8 = A2(
								_user$project$Tab$update,
								_user$project$Tab$TabDataReceived(_p7._0),
								tab);
				...
				extTabs: A2(
					...
					function (tab) {
						if (_elm_lang$core$Native_Utils.eq(tab, tabModel)) {
							var _p10 = A2(_user$project$Tab$update, tabMsg, tab);
							var updatedTab = _p10._0;
							return updatedTab;
						} else {
							return tab;
						}
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				extTabs: A2(
					_elm_lang$core$List$map,
					function (tab) {
						var _p11 = A2(_user$project$Tab$update, tabMsg, tab);
						var updatedTab = _p11._0;
						return updatedTab;
					},
					model.extTabs)
			});
...
var _user$project$DataWindow$getUpdatedRecords = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (r) {
			return _user$project$Row$getDaoUpdate(r);
		},
		_user$project$Tab$modifiedRows(model.mainTab));
};
var _user$project$DataWindow$getInsertedRecords = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (r) {
			return _user$project$Row$getDaoInsert(r);
		},
		_user$project$Tab$insertedRows(model.mainTab));
};
var _user$project$DataWindow$getSelectedOrigRecords = function (model) {
	return A2(
		...
		_user$project$Tab$selectedRows(model.mainTab));
};
var _user$project$DataWindow$getError = function (updateResponse) {
	var deleteErrorCount = _elm_lang$core$List$length(updateResponse.deleteError);
	return (_elm_lang$core$Native_Utils.cmp(deleteErrorCount, 0) > 0) ? _elm_lang$core$Maybe$Just(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'There was error deleting ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(deleteErrorCount),
				' records'))) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$DataWindow$subscription = function () {
	var _p12 = A2(_elm_lang$core$Debug$log, 'subscriptions in Datawindow', 'wohoo');
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[]));
}();
...
var _user$project$DataWindow$getFilter = function (model) {
	return _user$project$Tab$getSearchBoxQuery(model.mainTab);
};
var _user$project$DataWindow$getFullUrl = function (model) {
	var filter = _user$project$DataWindow$getFilter(model);
	var filterUrl = _elm_lang$core$Basics$not(
		_elm_lang$core$String$isEmpty(filter)) ? A2(_elm_lang$core$Basics_ops['++'], '?', filter) : '';
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {name: a, mainTab: b, presentation: c, mode: d, isActive: e, extTabs: f, hasManyMergedTabs: g, windowId: h, nextTabId: i, mainTableHeight: j, detailTableHeight: k, browserDimension: l, alert: m, focusedRow: n, formHeight: o, formMargin: p, openSequence: q};
																};
															};
														};
													};
...
var _user$project$DataWindow$create = F3(
	function (window, windowId, openSequence) {
		return {
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn btn-large btn-default'),
						_elm_lang$html$Html_Events$onClick(_user$project$DataWindow$CloseFocusedRow)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
...
var _user$project$DataWindow$UpdateExtensionRow = function (a) {
	return {ctor: 'UpdateExtensionRow', _0: a};
};
var _user$project$DataWindow$UpdateFocusedRow = function (a) {
	return {ctor: 'UpdateFocusedRow', _0: a};
};
...
var _user$project$DataWindow$extensionRowView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							function () {
							var _p13 = _user$project$Tab$firstRow(ext);
							if (_p13.ctor === 'Just') {
								var formedFirstRow = _elm_lang$core$Basics$fst(
									A2(
										_user$project$Row$update,
										_user$project$Row$ChangePresentation(_user$project$Row$Form),
										_p13._0));
...
var _user$project$DataWindow$ActivateWindow = function (a) {
...
var _user$project$DataWindow$toolbar = function (model) {
	var _p17 = function () {
		var _p18 = model.focusedRow;
		if (_p18.ctor === 'Just') {
			return A2(
				_elm_lang$core$Debug$log,
				'Record isNew in Toolbar: ',
				_user$project$Row$isNew(_p18._0));
		} else {
			return false;
		}
	}();
	var insertedRowCount = _user$project$Tab$insertedRowCount(model.mainTab);
	var modifiedRowCount = _user$project$Tab$modifiedRowCount(model.mainTab);
	var dirtyRecordCount = modifiedRowCount + insertedRowCount;
	var saveTooltip = function () {
		var records = (_elm_lang$core$Native_Utils.cmp(dirtyRecordCount, 1) > 0) ? 'records' : 'record';
		return _elm_lang$core$Native_Utils.eq(dirtyRecordCount, 0) ? 'No changes to save' : A2(
			_elm_lang$core$Basics_ops['++'],
			'Save ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(dirtyRecordCount),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						(_elm_lang$core$Native_Utils.cmp(dirtyRecordCount, 0) > 0) ? A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('badge badge-changes animated flash')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						(_elm_lang$core$Native_Utils.cmp(selectedRowCount, 0) > 0) ? A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('icon icon-trophy icon-text')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text('Clear Filter'),
						A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Remove the filters')
							]))
					])),
				A2(
				_elm_lang$html$Html$button,
...
var _user$project$DataWindow$UpdateRecords = F2(
	function (a, b) {
		return {ctor: 'UpdateRecords', _0: a, _1: b};
	});
var _user$project$DataWindow$LoadNextPage = function (a) {
	return {ctor: 'LoadNextPage', _0: a};
};
var _user$project$DataWindow$handleTabOutMsg = F2(
	function (model, outmsgs) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (outmsg, _p21) {
					var _p22 = _p21;
					var _p27 = _p22._1;
					var _p26 = _p22._0;
					var _p23 = outmsg;
						...
						case 'LoadNextPage':
							return {
								...
								_1: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_user$project$DataWindow$LoadNextPage(_p26.mainTab)
										]))
							};
						case 'FocusRow':
							var _p24 = _p23._0;
							if (_p24.ctor === 'Just') {
								...
								return {
									...
									_1: A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_user$project$DataWindow$FocusedRow(_p25)
											]))
								};
							} else {
...
var _user$project$DataWindow$updateMainTabThenHandleOutMsg = F2(
	function (tabMsg, model) {
		var _p28 = A2(_user$project$DataWindow$updateMainTab, tabMsg, model);
		var model1 = _p28._0;
		var outmsg = _p28._1;
		return A2(_user$project$DataWindow$handleTabOutMsg, model1, outmsg);
	});
var _user$project$DataWindow$update = F2(
	function (msg, model) {
		...
		switch (_p29.ctor) {
			case 'UpdateTab':
				var _p30 = A2(_user$project$DataWindow$updateMainTab, _p29._0, model);
				var model1 = _p30._0;
				var outmsg = _p30._1;
				var _p31 = A2(_elm_lang$core$Debug$log, 'Tab outmsg', outmsg);
				return A2(_user$project$DataWindow$handleTabOutMsg, model1, outmsg);
			case 'UpdateFocusedRow':
				var _p34 = _p29._0;
				var _p32 = A2(_elm_lang$core$Debug$log, 'Updating row', _p34);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							focusedRow: function () {
								var _p33 = model.focusedRow;
								if (_p33.ctor === 'Just') {
									return _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$fst(
											A2(_user$project$Row$update, _p34, _p33._0)));
								} else {
									return _elm_lang$core$Maybe$Nothing;
								}
							}()
			...
			case 'WindowDetailReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$DataWindow$updateWindow, _p29._0, model),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			case 'WindowDataReceived':
				var _p35 = _elm_lang$core$List$head(_p29._0);
				if (_p35.ctor === 'Just') {
					var _p36 = A2(
						_user$project$DataWindow$updateMainTab,
						_user$project$Tab$TabDataReceived(_p35._0),
						model);
					var model1 = _p36._0;
					var outmsg = _p36._1;
					return {
			...
			case 'ActivateWindow':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isActive: true, openSequence: _p29._0}),
					_1: _elm_lang$core$Native_List.fromArray(
						[
							_user$project$DataWindow$ModifyUrl(
							_user$project$DataWindow$getFullUrl(model))
			...
			case 'FocusedRecordDataReceived':
				...
				return {
					...
					_0: _user$project$DataWindow$openFirstMergedTab(
						A2(
							_user$project$DataWindow$hydrateAllMergedTab,
							_p37,
							A2(_user$project$DataWindow$hydrateExtensionTab, _p37, model))),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			case 'BrowserDimensionChanged':
				...
				return {
					...
					_0: _user$project$DataWindow$updateAllocatedHeight(
						A2(
							...
							_user$project$Tab$BrowserDimensionChanged(_p38),
							_elm_lang$core$Native_Utils.update(
								model,
								{browserDimension: _p38}))),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			case 'ToggleExtTab':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$DataWindow$updateExtTab, _user$project$Tab$Toggle, _p29._0, model),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
			case 'WindowDataNextPageReceived':
				var _p39 = _elm_lang$core$List$head(_p29._0);
				if (_p39.ctor === 'Just') {
					var _p40 = A2(
						_user$project$DataWindow$updateMainTab,
						_user$project$Tab$TabDataNextPageReceived(_p39._0),
						model);
					var model1 = _p40._0;
					var outmsg = _p40._1;
					return {
			...
			case 'ReceivedScrollBottomEvent':
				var _p41 = A2(_user$project$DataWindow$updateMainTab, _user$project$Tab$ReceivedScrollBottomEvent, model);
				var model1 = _p41._0;
				var outmsg = _p41._1;
				var _p42 = A2(_elm_lang$core$Debug$log, 'ReceivedScroll Tab outmsg', outmsg);
				return A2(_user$project$DataWindow$handleTabOutMsg, model1, outmsg);
			case 'ResizeStart':
				var _p43 = A2(_elm_lang$core$Debug$log, 'Starting resize..', _p29._0);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Native_List.fromArray(
			...
			case 'SetAlert':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							alert: _elm_lang$core$Maybe$Just(_p29._0)
						}),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				};
...
var _user$project$Main$httpRequest = F4(
	function (verb, model, body, url) {
		return A2(
			...
			_evancz$elm_http$Http$defaultSettings,
			{
				...
				headers: _elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'db_url', _1: model.settings.dbUrl}
					]),
				url: A2(_elm_lang$core$Basics_ops['++'], model.settings.apiServer, url),
				body: body
			});
	});
var _user$project$Main$httpDelete = F3(
	function (model, body, url) {
		return A4(_user$project$Main$httpRequest, 'DELETE', model, body, url);
	});
var _user$project$Main$httpPost = F3(
	function (model, body, url) {
		return A4(_user$project$Main$httpRequest, 'POST', model, body, url);
	});
var _user$project$Main$httpGet = F2(
	function (model, url) {
		return A4(_user$project$Main$httpRequest, 'GET', model, _evancz$elm_http$Http$empty, url);
	});
...
var _user$project$Main$getWindowTable = F2(
	function (model, windowId) {
		var _p0 = A2(_user$project$Main$getWindow, model, windowId);
		if (_p0.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(_p0._0.mainTab.tab.table);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
...
var _user$project$Main$lastOpenedWindow = function (model) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$sortBy,
			function (_) {
				return _.openSequence;
			},
			model.openedWindows));
};
var _user$project$Main$highestOpenSequence = function (model) {
	var _p1 = _user$project$Main$lastOpenedWindow(model);
	if (_p1.ctor === 'Just') {
		return _p1._0.openSequence;
	} else {
		return 0;
	}
};
var _user$project$Main$nextOpenSequence = function (model) {
	return _user$project$Main$highestOpenSequence(model) + 1;
};
var _user$project$Main$activateWindow1 = F2(
	function (windowId, model) {
		var openedWindowsOutMsg = A2(
			_elm_lang$core$List$map,
			function (window) {
				return _elm_lang$core$Native_Utils.eq(window.windowId, windowId) ? A2(
					_user$project$DataWindow$update,
					_user$project$DataWindow$ActivateWindow(
						_user$project$Main$nextOpenSequence(model)),
					window) : A2(_user$project$DataWindow$update, _user$project$DataWindow$DeactivateWindow, window);
			},
			model.openedWindows);
		var _p2 = _elm_lang$core$List$unzip(openedWindowsOutMsg);
		var openedWindows = _p2._0;
		var outmsgs = _p2._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$activateWindow = F2(
	function (windowId, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				openedWindows: A2(
					_elm_lang$core$List$map,
					function (window) {
						return _elm_lang$core$Native_Utils.eq(window.windowId, windowId) ? _elm_lang$core$Basics$fst(
							A2(
								_user$project$DataWindow$update,
								_user$project$DataWindow$ActivateWindow(
									_user$project$Main$nextOpenSequence(model)),
								window)) : _elm_lang$core$Basics$fst(
							A2(_user$project$DataWindow$update, _user$project$DataWindow$DeactivateWindow, window));
					},
					model.openedWindows)
			});
	});
var _user$project$Main$updateAllWindow = F2(
	function (windowMsg, model) {
		var updatedWindows = A2(
			_elm_lang$core$List$map,
			function (w) {
				var _p3 = A2(_user$project$DataWindow$update, windowMsg, w);
				var updatedWindow = _p3._0;
		...
		var updated_outmsgs = A2(
			...
			function (w) {
				if (_elm_lang$core$Native_Utils.eq(w.windowId, windowId)) {
					var _p4 = A2(_user$project$DataWindow$update, windowMsg, w);
					var window1 = _p4._0;
					var outmsg = _p4._1;
					var _p5 = A2(_elm_lang$core$Debug$log, 'Main outmsg', outmsg);
					return {ctor: '_Tuple2', _0: window1, _1: outmsg};
				} else {
					return {
						ctor: '_Tuple2',
						_0: w,
			...
			model.openedWindows);
		var _p6 = _elm_lang$core$List$unzip(updated_outmsgs);
		var windows = _p6._0;
		var outmsgs = _p6._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Main$openLastActivatedWindow = function (model) {
	var _p7 = _user$project$Main$lastOpenedWindow(model);
	if (_p7.ctor === 'Just') {
		return A2(_user$project$Main$activateWindow, _p7._0.windowId, model);
	} else {
		return model;
	}
};
var _user$project$Main$closeWindow = F2(
	function (model, windowId) {
		return _user$project$Main$openLastActivatedWindow(
			_elm_lang$core$Native_Utils.update(
				model,
				{
					openedWindows: A2(
...
var _user$project$Main$addWindow = F2(
	function (model, window) {
		var window1 = A3(
			_user$project$DataWindow$create,
			window,
			model.uid,
			_user$project$Main$nextOpenSequence(model));
		var _p8 = A2(
		...
		var allWindows = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[window3]));
		return A2(
			_user$project$Main$activateWindow,
			window3.windowId,
			_elm_lang$core$Native_Utils.update(
				model,
				{openedWindows: allWindows, uid: model.uid + 1}));
	});
var _user$project$Main$displayWindowDetail = F2(
	function (model, window) {
		return A2(_user$project$Main$addWindow, model, window);
	});
var _user$project$Main$modifyUrl = F2(
	function (model, url) {
		return _elm_lang$navigation$Navigation$modifyUrl(url);
	});
...
var _user$project$Main$appModel = {
	...
	defaultPageSize: 40,
	dragListenWindow: _elm_lang$core$Maybe$Nothing,
	settings: A2(_user$project$Settings$init, '', '')
};
...
var _user$project$Main$saveSettings = function (model) {
	return _elm_lang$core$Platform_Cmd$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$saveSettingsDbUrl(model.settings.dbUrl),
				_user$project$Main$saveSettingsApiServer(model.settings.apiServer)
			]));
};
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {title: a, windowList: b, openedWindows: c, error: d, uid: e, isSettingsOpened: f, browserDimension: g, defaultPageSize: h, dragListenWindow: i, settings: j};
									};
								};
							};
						};
...
var _user$project$Main$UpdateError = F2(
	function (a, b) {
		return {ctor: 'UpdateError', _0: a, _1: b};
	});
var _user$project$Main$RecordsUpdated = F2(
	function (a, b) {
		return {ctor: 'RecordsUpdated', _0: a, _1: b};
	});
var _user$project$Main$httpUpdateRecords = F4(
	function (model, windowId, mainTable, body) {
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Main$UpdateError(windowId),
			_user$project$Main$RecordsUpdated(windowId),
			A2(
				_evancz$elm_http$Http$fromJson,
				_elm_lang$core$Json_Decode$list(_user$project$Dao$updateResponseDecoder),
				A5(
					_elm_lang$core$Debug$log,
					'httpUpdateRecords',
...
var _user$project$Main$handleSettingsOutMsg = F2(
	function (model, outmsgs) {
		var _p10 = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (outmsg, _p11) {
					var _p12 = _p11;
					var _p16 = _p12._1;
					var _p15 = _p12._0;
					var _p13 = outmsg;
					if (_p13.ctor === 'CloseWindow') {
						return {
							ctor: '_Tuple2',
							_0: _user$project$Main$closeSettingsWindow(_p15),
							_1: _p16
						};
					} else {
						var _p14 = A2(_elm_lang$core$Debug$log, 'Apllying the settings down....', '');
						return {
							ctor: '_Tuple2',
							_0: _p15,
							_1: A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_user$project$Main$testDbConnection(_p15),
										_user$project$Main$saveSettings(_p15)
									]))
						};
					}
				}),
			...
			outmsgs);
		var model2 = _p10._0;
		var newoutList = _p10._1;
		return {
			ctor: '_Tuple2',
			_0: model2,
			_1: _elm_lang$core$Platform_Cmd$batch(newoutList)
		};
	});
...
var _user$project$Main$getWindowDataPagedQuery = F6(
	function (mainTable, windowId, page, pageSize, filter, model) {
		var pageQuery = A2(_user$project$Main$pageSizeQuery, page, pageSize);
		var query = _elm_lang$core$String$isEmpty(filter) ? pageQuery : A2(
			_elm_lang$core$Basics_ops['++'],
			filter,
			A2(_elm_lang$core$Basics_ops['++'], '&', pageQuery));
		return A4(_user$project$Main$getWindowDataWithQuery, model, mainTable, windowId, query);
	});
var _user$project$Main$loadNextPage = F2(
	function (windowId, model) {
		var _p17 = A2(_user$project$Main$getWindow, model, windowId);
		if (_p17.ctor === 'Just') {
			var _p22 = _p17._0;
			var totalPage = function () {
				var _p18 = _p22.mainTab.totalPage;
				if (_p18.ctor === 'Just') {
					return _p18._0;
				} else {
					return 0;
			...
			var pageSize = function () {
				var _p19 = _p22.mainTab.pageSize;
				if (_p19.ctor === 'Just') {
					return _p19._0;
				} else {
					return 0;
			...
			var table = _p22.mainTab.tab.table;
			if (_elm_lang$core$Native_Utils.cmp(nextPage, totalPage) < 0) {
				var filter = _user$project$DataWindow$getFilter(_p22);
				return A6(_user$project$Main$getWindowDataPagedQuery, table, windowId, nextPage, pageSize, filter, model);
			} else {
				var _p21 = _elm_lang$core$Debug$log('Has reached the last page');
...
var _user$project$Main$fetchFocusedRecordDetail = F3(
	function (model, windowId, rowId) {
		...
		var _p23 = mainTable;
		if (_p23.ctor === 'Just') {
			var _p24 = A2(_user$project$Main$getWindow, model, windowId);
			if (_p24.ctor === 'Just') {
				var _p25 = A2(_user$project$Tab$getRow, _p24._0.mainTab, rowId);
				if (_p25.ctor === 'Just') {
					var focusedParam = _user$project$Row$focusedRecordParam(_p25._0);
					return A3(
						_elm_lang$core$Task$perform,
						_user$project$Main$FetchError,
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 746, column: 21},
							end: {line: 754, column: 54}
						},
						_p25)('No such row');
				}
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 744, column: 13},
						end: {line: 756, column: 49}
					},
					_p24)('No such window');
			}
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 742, column: 5},
					end: {line: 759, column: 63}
				},
				_p23)('No matching table for focused record');
		}
	});
...
var _user$project$Main$getWindowData = F3(
	function (model, mainTable, windowId) {
		var pageQuery = A2(_user$project$Main$pageSizeQuery, 0, model.defaultPageSize);
		var filter = function () {
			var _p29 = A2(_user$project$Main$getWindow, model, windowId);
			if (_p29.ctor === 'Just') {
				return _user$project$DataWindow$getFilter(_p29._0);
			} else {
				return '';
			}
		}();
		var query = _elm_lang$core$String$isEmpty(filter) ? pageQuery : A2(
			...
			filter,
			A2(_elm_lang$core$Basics_ops['++'], '&', pageQuery));
		var _p30 = A2(_elm_lang$core$Debug$log, 'Requesting resource', query);
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Main$FetchError,
...
var _user$project$Main$handleWindowOutMsg = F3(
	function (outmsgs, model, windowId) {
		var _p31 = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (outmsg, _p32) {
					var _p33 = _p32;
					var _p38 = _p33._0;
					var _p37 = _p33._1;
					var _p34 = outmsg;
						...
						case 'LoadNextPage':
							return {
								...
								_1: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A2(_user$project$Main$loadNextPage, windowId, _p38)
										]))
							};
						case 'UpdateRecords':
							return {
								...
								_1: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A4(_user$project$Main$httpUpdateRecords, _p38, windowId, _p34._0, _p34._1)
										]))
							};
						case 'FocusedRow':
							return {
						...
						case 'DoRefreshRecords':
							return {
								...
								_1: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A3(_user$project$Main$getWindowData, _p38, _p34._1, _p34._0)
										]))
							};
						default:
							var _p36 = _p34._0;
							var _p35 = A2(_elm_lang$core$Debug$log, 'Modify the URL to', _p36);
							return {
								ctor: '_Tuple2',
								_0: _p38,
								_1: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A2(_user$project$Main$modifyUrl, _p38, _p36)
										]))
							};
					}
				}),
...
var _user$project$Main$updateThenHandleWindowMsg = F3(
	function (model, windowMsg, windowId) {
		var _p39 = A3(_user$project$Main$updateWindow, model, windowMsg, windowId);
		var model1 = _p39._0;
		var outmsg = _p39._1;
		return A3(_user$project$Main$handleWindowOutMsg, outmsg, model1, windowId);
	});
var _user$project$Main$updateActiveWindow = F2(
	function (model, windowMsg) {
		var activeWindow = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (window) {
				...
				model.openedWindows));
		var _p40 = activeWindow;
		if (_p40.ctor === 'Just') {
			return A3(_user$project$Main$updateThenHandleWindowMsg, model, windowMsg, _p40._0.windowId);
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Main$activateWindowThenHandleWindowMsg = F2(
	function (windowId, model) {
		var _p41 = A2(_user$project$Main$activateWindow1, windowId, model);
		var model1 = _p41._0;
		var outmsg = _p41._1;
		return A3(_user$project$Main$handleWindowOutMsg, outmsg, model1, windowId);
	});
...
var _user$project$Main$subscriptions = function (model) {
	var _p42 = A2(_elm_lang$core$Debug$log, 'setting up subscription', '');
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				function () {
				var _p43 = model.dragListenWindow;
				if (_p43.ctor === 'Just') {
					var _p45 = _p43._0;
					var _p44 = A2(_user$project$Main$getWindow, model, _p45);
					if (_p44.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Sub$map,
							_user$project$Main$UpdateWindow(_p45),
							_user$project$DataWindow$subscriptions(_p44._0));
					} else {
						return _elm_lang$core$Platform_Sub$none;
					}
				} else {
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								model.isSettingsOpened ? A2(
								_elm_lang$html$Html_App$map,
								_user$project$Main$UpdateSettings,
								_user$project$Settings$view(model.settings)) : A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p46.ctor) {
			case 'UpdateWindow':
				return A3(_user$project$Main$updateThenHandleWindowMsg, model, _p46._1, _p46._0);
			case 'CloseWindow':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Main$closeWindow, model, _p46._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ActivateWindow':
				return A2(_user$project$Main$activateWindowThenHandleWindowMsg, _p46._0, model);
			case 'UpdateWindowList':
				var _p47 = A2(_user$project$WindowList$update, _p46._0, model.windowList);
				var window_list = _p47._0;
				var outmsg = _p47._1;
				var model1 = _elm_lang$core$Native_Utils.update(
					model,
				...
				if (_p48.ctor === 'Nothing') {
					...
					return {
						ctor: '_Tuple2',
						_0: model1,
						_1: A2(_user$project$Main$fetchWindowDetail, model1, _p48._0._0)
					};
				}
			case 'GetWindowList':
				return {
			...
			case 'WindowDetailReceived':
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Main$displayWindowDetail, model, _p50),
			...
			case 'FetchError':
				var _p52 = _p46._0;
				var _p51 = A2(_elm_lang$core$Debug$log, 'There was an error fetching records', _p52);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateSettings':
				var _p53 = A2(_user$project$Settings$update, _p46._0, model.settings);
				var updatedSettings = _p53._0;
				var outmsgs = _p53._1;
				var model1 = _elm_lang$core$Native_Utils.update(
					model,
					{settings: updatedSettings});
				return A2(_user$project$Main$handleSettingsOutMsg, model1, outmsgs);
			...
			case 'WindowResize':
				...
				var updatedDimension = _elm_lang$core$Native_Utils.update(
					dimension,
					{width: _p54.width, height: _p54.height});
				return {
					ctor: '_Tuple2',
					_0: A2(
			...
			case 'ReceivedScrollBarWidth':
				...
				var updatedDimension = _elm_lang$core$Native_Utils.update(
					dimension,
					{scrollBarWidth: _p56});
				var _p55 = A2(_elm_lang$core$Debug$log, 'received scrollbar width', _p56);
				return {
					ctor: '_Tuple2',
					_0: A2(
						_user$project$Main$updateAllWindow,
			...
			case 'ReceivedScrollBottomEvent':
				return A2(
					...
					model,
					_user$project$DataWindow$ReceivedScrollBottomEvent(_p46._0));
			case 'WindowDataNextPageReceived':
				var _p58 = _p46._0;
				var _p57 = A2(_elm_lang$core$Debug$log, 'got next page for ', _p58);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$fst(
						A3(
			...
			case 'CacheReset':
				var _p59 = A2(_elm_lang$core$Debug$log, 'cache has been reset', '');
				return {
					ctor: '_Tuple2',
			...
			case 'ReceivedSettingsDbUrl':
				var _p61 = _p46._0;
				var _p60 = A2(_elm_lang$core$Debug$log, 'received settings db_url', _p61);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							settings: _elm_lang$core$Basics$fst(
								A2(
									_user$project$Settings$update,
									_user$project$Settings$ChangeDbUrl(_p61),
									model.settings))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ReceivedSettingsApiServer':
				var _p63 = _p46._0;
				var _p62 = A2(_elm_lang$core$Debug$log, 'received settings api_server', _p63);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							settings: _elm_lang$core$Basics$fst(
								A2(
									_user$project$Settings$update,
									_user$project$Settings$ChangeApiServer(_p63),
									model.settings))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DbConnectionTested':
				var _p66 = _p46._0;
				var _p64 = A2(_elm_lang$core$Debug$log, 'Database connection tested', _p66);
				if (_elm_lang$core$Native_Utils.eq(_p66, 'OK')) {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								settings: _elm_lang$core$Basics$fst(
									A2(_user$project$Settings$update, _user$project$Settings$DbConnectionTested, model.settings))
							}),
						_1: _user$project$Main$resetCache(model)
					};
				} else {
					var _p65 = _elm_lang$core$Debug$log('Unable to connect to database');
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'DbConnectionTestError':
				var _p69 = _p46._0;
				var _p67 = A2(_elm_lang$core$Debug$log, 'There is an error with this request', _p69);
				var _p68 = _p69;
				if (_p68.ctor === 'NetworkError') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								settings: _elm_lang$core$Basics$fst(
									A2(_user$project$Settings$update, _user$project$Settings$NetworkError, model.settings))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								settings: _elm_lang$core$Basics$fst(
									A2(_user$project$Settings$update, _user$project$Settings$DbConnectionTestError, model.settings))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'RecordsUpdated':
				return A3(
					_user$project$Main$updateThenHandleWindowMsg,
					model,
					_user$project$DataWindow$RecordsUpdated(_p46._1),
					_p46._0);
			case 'UpdateError':
				var _p71 = _p46._1;
				var _p70 = A2(_elm_lang$core$Debug$log, 'Update error', _p71);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$fst(
						A3(
							_user$project$Main$updateWindow,
							model,
							_user$project$DataWindow$SetAlert(
								_elm_lang$core$Basics$toString(_p71)),
							_p46._0)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DragAt':
				var _p72 = A2(_elm_lang$core$Debug$log, 'DragAt', _p46._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var _p73 = A2(_elm_lang$core$Debug$log, 'DragEnd', _p46._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
