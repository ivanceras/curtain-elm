...
var _user$project$Dao$firstValue = F2(
...
var _user$project$Dao$valueVariant = function (tag) {
	var _p2 = tag;
	switch (_p2) {
		case 'Bool':
			return A2(
				...
				A2(
					...
					_user$project$Dao$firstValue(false)));
		case 'I8':
			return A2(
				_elm_lang$core$Json_Decode$map,
				...
				A2(
					...
					_user$project$Dao$firstValue(0)));
		case 'I16':
			return A2(
				_elm_lang$core$Json_Decode$map,
				...
				function (f) {
					...
					if (_p9.ctor === 'Just') {
						...
						return _elm_lang$core$Native_Utils.crashCase(
							'Field',
							{
								start: {line: 617, column: 13},
								end: {line: 629, column: 46}
							},
							_p9)('no keyfield');
					}
				},
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(
								_user$project$Dao$String(_p29._0))
						}),
			...
			case 'ChangeValueBool':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							value: _elm_lang$core$Maybe$Just(
								_user$project$Dao$Bool(_p29._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeMode':
			...
			case 'SetValue':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(_p29._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$Field$fieldEntry = function (model) {
	...
	var width = function () {
		var _p34 = model.field.displayLength;
		if (_p34.ctor === 'Just') {
			return _p34._0 * 10;
		} else {
			return 200;
		...
		switch (_p37) {
			...
			case 'Bool':
				var boolValue = function () {
					var _p38 = model.value;
					if ((_p38.ctor === 'Just') && (_p38._0.ctor === 'Bool')) {
						return _p38._0._0;
					} else {
						return false;
					}
...
var _user$project$Field$view = function (model) {
	var width = function () {
		var _p39 = model.field.displayLength;
		if (_p39.ctor === 'Just') {
			return _p39._0 * 10;
		} else {
			return 200;
		...
		default:
			...
			if (_p45.ctor === 'Edit') {
				...
				switch (_p46.ctor) {
					...
					default:
						var width = function () {
							var _p47 = model.field.displayLength;
							if (_p47.ctor === 'Just') {
								return _p47._0 * 10;
							} else {
								return 200;
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$Row$CancelChanges)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$Row$SaveChanges)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
	...
	function (model, tableDao) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				...
				totalPage: function () {
					var _p4 = tableDao.total;
					if (_p4.ctor === 'Just') {
						var _p5 = tableDao.pageSize;
						if (_p5.ctor === 'Just') {
							var _p7 = _p5._0;
							var totalPage = (((_p4._0 + _p7) - 1) / _p7) | 0;
							var _p6 = A2(_elm_lang$core$Debug$log, 'totalPage: ', totalPage);
	...
	function (model, tableDao) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				...
				totalRecords: tableDao.total,
				totalPage: function () {
					var _p8 = tableDao.total;
					if (_p8.ctor === 'Just') {
						var _p9 = tableDao.pageSize;
						if (_p9.ctor === 'Just') {
							var _p11 = _p9._0;
							var totalPage = (((_p8._0 + _p11) - 1) / _p11) | 0;
							var _p10 = A2(_elm_lang$core$Debug$log, 'totalPage: ', totalPage);
							return _elm_lang$core$Maybe$Just(totalPage);
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
...
var _user$project$Tab$removeFocusedRecord = function (model) {
	var updatedRows = A2(
		_elm_lang$core$List$map,
		function (r) {
			var _p12 = A2(_user$project$Row$update, _user$project$Row$LooseFocusRecord, r);
			var mo = _p12._0;
			var cmd = _p12._1;
			return mo;
		},
...
var _user$project$Tab$updateFocusedRow = F2(
	function (rowId, model) {
		...
		var updatedRows = A2(
			...
			function (r) {
				if (_elm_lang$core$Native_Utils.eq(r.rowId, rowId)) {
					var _p14 = A2(_user$project$Row$update, _user$project$Row$FocusRecord, r);
					var mo = _p14._0;
					var cmd = _p14._1;
					return mo;
				} else {
					var _p15 = A2(_user$project$Row$update, _user$project$Row$LooseFocusRecord, r);
					var mo = _p15._0;
					var cmd = _p15._1;
					return mo;
				}
	...
	if (_p16.ctor === 'Nothing') {
		...
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (r) {
					return _elm_lang$core$Native_Utils.eq(r.rowId, _p16._0);
				},
				model.rows));
	}
};
	...
	function (msg, model) {
		...
		switch (_p19.ctor) {
			case 'UpdateRow':
				...
				switch (_p20.ctor) {
					case 'FocusRecord':
						return {
							...
							_0: A3(
								...
								_p22,
								_p21,
								A2(_user$project$Tab$updateFocusedRow, _p21, model)),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Selection':
						...
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Tab$updateRow, _p22, _p21, updatedModel),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'EditRecordInForm':
						return {
					...
					default:
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Tab$updateRow, _p22, _p21, model),
							_1: _elm_lang$core$Platform_Cmd$none
						};
				}
			case 'ChangeMode':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$updateMode, _p19._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangePresentation':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$updatePresentation, _p19._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeDensity':
				var _p23 = _p19._0;
				return {
					...
					_0: A2(
						...
						_user$project$Row$ChangeDensity(_p23),
						_elm_lang$core$Native_Utils.update(
							model,
							{density: _p23})),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'TabDataReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$setTabRows, model, _p19._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectionAll':
				return {
					...
					_0: A2(
						_user$project$Tab$updateAllRows,
						_user$project$Row$Selection(_p19._0),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LookupTabsReceived':
				var listLookupFields = _user$project$Tab$buildLookupField(_p19._0);
				return {
					ctor: '_Tuple2',
					_0: A2(
						_user$project$Tab$updateAllRows,
			...
			case 'LookupDataReceived':
				return {
					...
					_0: A2(
						_user$project$Tab$updateAllRows,
						_user$project$Row$LookupDataReceived(_p19._0),
						model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Open':
			...
			case 'BrowserDimensionChanged':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{browserDimension: _p19._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TabDataNextPageReceived':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Tab$addToRows, model, _p19._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p24 = A2(_elm_lang$core$Debug$log, '----> RECEIVED SCROLL BOTTOM EVENT', '..');
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Tab$filterStatusView = function (model) {
	...
	var rowCountText = function () {
		var _p26 = model.tab.estimatedRowCount;
		if (_p26.ctor === 'Just') {
			return _elm_lang$html$Html$text(
...
var _user$project$Tab$onTableScroll = function (msg) {
	var _p28 = A2(_elm_lang$core$Debug$log, 'targetValue', _elm_lang$html$Html_Events$targetValue);
	var _p29 = A2(_elm_lang$core$Debug$log, 'scrolling...', msg);
	return A2(
		_elm_lang$html$Html_Events$on,
		'scroll',
...
var _user$project$Tab$emptyRowForm = function (model) {
	var _p30 = A2(_elm_lang$core$Debug$log, 'creating emptyRow in form using ', model.tab.fields);
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									if (_p34.ctor === 'Just') {
										...
										return A2(
											_elm_lang$html$Html_App$map,
											_user$project$Tab$UpdateRow(_p35.rowId),
											_user$project$Row$view(_p35));
									} else {
										return A2(
											_elm_lang$html$Html_App$map,
...
var _user$project$DataWindow$update = F2(
	function (msg, model) {
		...
		switch (_p11.ctor) {
			case 'UpdateTab':
				var _p17 = _p11._0;
				var _p12 = A2(_elm_lang$core$Debug$log, 'Update tab', _p17);
				var _p13 = _p17;
				switch (_p13.ctor) {
					case 'ChangePresentation':
						return {
				...
				return {
					...
					_0: function () {
						...
						if (_p18.ctor === 'Just') {
							return A2(
								_user$project$DataWindow$updateMainTab,
								_user$project$Tab$TabDataReceived(_p18._0),
								model);
						} else {
							return model;
						}
				...
				return {
					...
					_0: _user$project$DataWindow$updateAllocatedHeight(
						A2(
							...
							_user$project$Tab$BrowserDimensionChanged(_p19),
							_elm_lang$core$Native_Utils.update(
								model,
								{browserDimension: _p19}))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleExtTab':
				return {
			...
			case 'WindowDataNextPageReceived':
				return {
					ctor: '_Tuple2',
					_0: function () {
						var _p20 = _elm_lang$core$List$head(_p11._0);
						if (_p20.ctor === 'Just') {
							return A2(
								_user$project$DataWindow$updateMainTab,
								_user$project$Tab$TabDataNextPageReceived(_p20._0),
								model);
						} else {
							return model;
						}
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$DataWindow$updateMainTab, _user$project$Tab$ReceivedScrollBottomEvent, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Settings$update = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'In Settings.update', 'here...');
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'ChangeDbUrl':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							dbUrl: _elm_lang$core$Maybe$Just(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeApiServer':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							apiServer: _elm_lang$core$Maybe$Just(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$getWindowTable = F2(
	function (model, windowId) {
		var _p2 = A2(_user$project$Main$getWindow, model, windowId);
		if (_p2.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(_p2._0.mainTab.tab.table);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
...
var _user$project$Main$getActiveWindow = function (model) {
	var _p3 = model.activeWindow;
	if (_p3.ctor === 'Just') {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (w) {
					return _elm_lang$core$Native_Utils.eq(w.windowId, _p3._0);
				},
				model.openedWindows));
	} else {
		return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Main$updateActivatedWindowList = function (model) {
	var windowList = function () {
		var _p4 = _user$project$Main$getActiveWindow(model);
		if (_p4.ctor === 'Just') {
			var _p5 = A2(
				_user$project$WindowList$update,
				_user$project$WindowList$UpdateActivated(_p4._0.mainTab.tab.table),
				model.windowList);
			var mo = _p5._0;
			var cmd = _p5._1;
			return mo;
...
var _user$project$Main$deactivateOpenedWindows = function (model) {
	var updatedWindows = A2(
		_elm_lang$core$List$map,
		function (w) {
			var _p6 = A2(_user$project$DataWindow$update, _user$project$DataWindow$DeactivateWindow, w);
			var mo = _p6._0;
			var cmd = _p6._1;
			return mo;
		},
...
var _user$project$Main$activateFirstWindow = function (model) {
	var _p7 = _elm_lang$core$List$head(model.openedWindows);
	if (_p7.ctor === 'Just') {
		var _p9 = _p7._0;
		var _p8 = A2(_user$project$DataWindow$update, _user$project$DataWindow$ActivateWindow, _p9);
		var updatedWindow = _p8._0;
		var cmd = _p8._1;
		var allWindows = A2(
			_elm_lang$core$List_ops['::'],
			updatedWindow,
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				activeWindow: _elm_lang$core$Maybe$Just(_p9.windowId),
...
var _user$project$Main$updateActivatedWindows = function (model) {
	...
	var _p10 = model.activeWindow;
	if (_p10.ctor === 'Just') {
		var _p12 = _p10._0;
		if (A2(_user$project$Main$inOpenedWindows, model, _p12)) {
			var updatedWindows = A2(
				_elm_lang$core$List$map,
				function (w) {
					if (_elm_lang$core$Native_Utils.eq(w.windowId, _p12)) {
						var _p11 = A2(_user$project$DataWindow$update, _user$project$DataWindow$ActivateWindow, w);
						var mo = _p11._0;
						var cmd = _p11._1;
						return mo;
					} else {
...
var _user$project$Main$updateSettings = F2(
	function (settingsMsg, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				settingsModel: function () {
					var _p18 = model.settingsModel;
					if (_p18.ctor === 'Just') {
						var _p19 = A2(_user$project$Settings$update, settingsMsg, _p18._0);
						var updatedSettings = _p19._0;
						return _elm_lang$core$Maybe$Just(updatedSettings);
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				}()
...
var _user$project$Main$appModel = {
	title: 'Curtain UI',
	dbUrl: _elm_lang$core$Maybe$Just('postgres://postgres:p0stgr3s@localhost:5432/guardian'),
	apiServer: _elm_lang$core$Maybe$Just('http://localhost:3224'),
...
var _user$project$Main$receivedScrollBottomEvent = _elm_lang$core$Native_Platform.incomingPort('receivedScrollBottomEvent', _elm_lang$core$Json_Decode$string);
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$receivedScrollBottomEvent(_user$project$Main$ReceivedScrollBottomEvent)
			]));
};
...
var _user$project$Main$loadNextPage = F2(
	function (windowId, model) {
		var _p20 = A2(_user$project$Main$getWindow, model, windowId);
		if (_p20.ctor === 'Just') {
			var _p25 = _p20._0;
			var totalPage = function () {
				var _p21 = _p25.mainTab.totalPage;
				if (_p21.ctor === 'Just') {
					return _p21._0;
				} else {
					return 0;
			...
			var pageSize = function () {
				var _p22 = _p25.mainTab.pageSize;
				if (_p22.ctor === 'Just') {
					return _p22._0;
				} else {
					return 0;
			...
			var table = _p25.mainTab.tab.table;
			if (_elm_lang$core$Native_Utils.cmp(nextPage, totalPage) < 0) {
				...
				var _p24 = _elm_lang$core$Debug$log('Has reached the last page');
...
var _user$project$Main$shallLoadNextPage = F2(
	function (windowId, model) {
		var _p26 = A2(_user$project$Main$getWindow, model, windowId);
		if (_p26.ctor === 'Just') {
			if (_elm_lang$core$Basics$not(_p26._0.mainTab.loadingPage)) {
				return A2(_user$project$Main$loadNextPage, windowId, model);
			} else {
				var _p27 = A2(_elm_lang$core$Debug$log, 'Ignoring LoadNextPage request', '');
				return _elm_lang$core$Platform_Cmd$none;
			}
		} else {
			return _elm_lang$core$Platform_Cmd$none;
...
var _user$project$Main$fetchFocusedRecordDetail = F3(
	function (model, windowId, rowId) {
		...
		if (_p28.ctor === 'Just') {
			...
			if (_p29.ctor === 'Just') {
				var _p30 = A2(_user$project$Tab$getRow, _p29._0.mainTab, rowId);
				if (_p30.ctor === 'Just') {
					var focusedParam = A2(
						_elm_lang$core$Basics_ops['++'],
						'[',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Row$focusedRecordParam(_p30._0),
							']'));
					return A3(
						_elm_lang$core$Task$perform,
						_user$project$Main$FetchError,
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 637, column: 21},
							end: {line: 645, column: 54}
						},
						_p30)('No such row');
				}
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 635, column: 13},
						end: {line: 647, column: 49}
					},
					_p29)('No such window');
			}
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					...
					end: {line: 650, column: 63}
				},
				_p28)('No matching table for focused record');
		}
	});
			...
			return A3(
				...
				A2(
					...
					A2(
						_user$project$Main$httpGet,
						model,
						A2(_elm_lang$core$Basics_ops['++'], '/lookup_data/', _p34._0))));
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 621, column: 5},
					end: {line: 627, column: 54}
				},
				_p34)('Unable to get matching table');
		}
	});
			...
			return A3(
				...
				A2(
					...
					A2(
						_user$project$Main$httpGet,
						model,
						A2(_elm_lang$core$Basics_ops['++'], '/lookup_tabs/', _p36._0))));
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 609, column: 5},
					end: {line: 615, column: 54}
				},
				_p36)('Unable to get matching table');
		}
	});
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								if (model.isSettingsOpened) {
									var _p38 = model.settingsModel;
									if (_p38.ctor === 'Just') {
										return A2(
											_elm_lang$html$Html_App$map,
											_user$project$Main$UpdateSettings,
											_user$project$Settings$view(_p38._0));
									} else {
	...
	function (msg, model) {
		...
		switch (_p39.ctor) {
			case 'UpdateWindow':
				var _p42 = _p39._1;
				var _p40 = msg;
				if ((((_p40.ctor === 'UpdateWindow') && (_p40._1.ctor === 'UpdateTab')) && (_p40._1._0.ctor === 'UpdateRow')) && (_p40._1._0._1.ctor === 'FocusRecord')) {
					var _p41 = _p40._0;
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$updateWindow, model, _p42, _p41),
						_1: A3(_user$project$Main$fetchFocusedRecordDetail, model, _p41, _p40._1._0._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$updateWindow, model, _p42, _p39._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'CloseWindow':
			...
			case 'UpdateWindowList':
				var _p43 = _p39._0;
				if (_p43.ctor === 'LoadWindow') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_user$project$Main$fetchWindowDetail, model, _p43._0)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'LoadWindow':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$fetchWindowDetail, model, _p39._0)
				};
			case 'GetWindowData':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'WindowDataReceived':
			...
			case 'UpdateSettings':
				var _p51 = _p39._0;
				var _p48 = A2(_elm_lang$core$Debug$log, 'settings', _p51);
				var _p49 = _p51;
				switch (_p49.ctor) {
					case 'CloseWindow':
						return {
						...
						return {
							...
							_0: A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										dbUrl: _elm_lang$core$Maybe$Just(_p49._0)
									})),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'ChangeApiServer':
						return {
							...
							_0: A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										apiServer: _elm_lang$core$Maybe$Just(_p49._0)
									})),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					default:
						var _p50 = A2(_elm_lang$core$Debug$log, 'Apllying the settings down....', '');
						return {
							ctor: '_Tuple2',
							_0: A2(
								_user$project$Main$updateSettings,
			...
			case 'ReceivedScrollBottomEvent':
				var _p53 = model.activeWindow;
				if (_p53.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: A2(
							_user$project$Main$updateActiveWindow,
							_user$project$DataWindow$ReceivedScrollBottomEvent(_p39._0),
							model),
						_1: A2(_user$project$Main$shallLoadNextPage, _p53._0, model)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				var _p55 = _p39._0;
				var _p54 = A2(_elm_lang$core$Debug$log, 'got next page for ', _p55);
				return {
					ctor: '_Tuple2',
					_0: A3(
						_user$project$Main$updateWindow,
